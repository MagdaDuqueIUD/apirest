...
//app.use('public/uploads', produccionRoutes.subirImagen);
app.use(express.static('../public'));

// settings
app.set('port', process.env.PORT || 4000); // este app se puede referenciar desde cualquier parte de la aplicación por eso no se pone como variable
